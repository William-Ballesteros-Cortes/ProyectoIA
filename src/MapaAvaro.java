...
public class MapaAvaro extends MapaCU{
    ...
    public MapaAvaro(int[][] contadorItems,boolean devolverse,List<int[]> moviJugador, List<String> direccion, int acumulado, int[][] navesI, int heuristicaI){
        super(contadorItems, devolverse, moviJugador, direccion, acumulado, navesI);
